...
var CardGroup = React6.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CarouselCaption = React7.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var CarouselItem = React8.forwardRef(({
  ...
  const finalClassName = (0, import_classnames8.default)(className, useBootstrapPrefix(bsPrefix, "carousel-item"));
...
function map(children, func) {
  let index = 0;
  return React9.Children.map(children, (child) => React9.isValidElement(child) ? func(child, index++) : child);
}
function forEach(children, func) {
  let index = 0;
  React9.Children.forEach(children, (child) => {
    if (React9.isValidElement(child)) func(child, index++);
  });
}
function hasChildOfType(children, type) {
  return React9.Children.toArray(children).some((child) => React9.isValidElement(child) && child.type === type);
}
...
var Carousel = (
  ...
  React10.forwardRef(({
    ...
    return (0, import_jsx_runtime10.jsxs)(Component2, {
      ...
      className: (0, import_classnames9.default)(className, prefix, slide && "slide", fade && `${prefix}-fade`, variant && `${prefix}-${variant}`),
        ...
        children: map(children, (child, index) => {
          ...
          return slide ? (0, import_jsx_runtime9.jsx)(TransitionWrapper_default, {
            ...
            children: (status, innerProps) => React10.cloneElement(child, {
              ...innerProps,
              className: (0, import_classnames9.default)(child.props.className, isActive && status !== "entered" && orderClassName, (status === "entered" || status === "exiting") && "active", (status === "entering" || status === "exiting") && directionalClassName)
            })
          }) : React10.cloneElement(child, {
            className: (0, import_classnames9.default)(child.props.className, isActive && "active")
          });
        })
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react8.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
var SelectableContext = React15.createContext(null);
...
var NavContext = React16.createContext(null);
...
var DropdownItem = React17.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime15.jsx)(Component2, Object.assign({}, props, {
    ref
  }, dropdownItemProps));
});
...
function Dropdown({
  ...
  return (0, import_jsx_runtime16.jsx)(SelectableContext_default.Provider, {
    value: handleSelect,
    children: (0, import_jsx_runtime16.jsx)(DropdownContext_default.Provider, {
      value: context3,
      children
    })
  });
...
var context2 = React25.createContext(null);
...
var FormGroup = React41.forwardRef(({
  ...
  const context3 = (0, import_react27.useMemo)(() => ({
    controlId
  }), [controlId]);
...
var FormLabel = React42.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime39.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
...
var Modal = (0, import_react42.forwardRef)((_ref, ref) => {
  ...
  return (0, import_jsx_runtime55.jsx)(import_jsx_runtime55.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime55.jsxs)(import_jsx_runtime55.Fragment, {
...
var NavbarOffcanvas = React78.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context3 = (0, import_react51.useContext)(NavbarContext_default);
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime91.jsxs)(import_jsx_runtime90.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react57.cloneElement)(children, triggerProps), (0, import_jsx_runtime89.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context3 = (0, import_react59.useContext)(TabContext_default);
...
var ToastHeader = React105.forwardRef(({
  ...
  const context3 = (0, import_react61.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
